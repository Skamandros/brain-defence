...
class Projectile(arcade.Sprite):
    def __init__(self, x, y, target: Impression, damage, image_filepath, image_scaling=1, speed=100):
...
class BaseProjectile(Projectile):
    def __init__(self, x, y, target, damage):
        super().__init__(x, y, target, damage, RESOURCE_DIR.joinpath("buildings").joinpath("tower-base-projectile.png").resolve(), speed=750)
