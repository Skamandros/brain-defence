...
class LevelThreeMap(BaseMap):
    def __init__(self):
        super().__init__(
            RESOURCE_DIR.joinpath("maps/Level-three.tmx").resolve(), maxBrainHealth=500, minBrainHealth=0, currentBrainHealth=500, level=3
        )
        self.impressions_spawned = 0
        self._max_spawned_impressions = 45
